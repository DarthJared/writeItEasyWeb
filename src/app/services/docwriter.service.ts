...
export class DocwriterService {
  ...
  pageBreakXML = `<w:p w:rsidR="00AA39DF" w:rsidRDefault="00AA39DF"><w:r><w:br w:type="page"/></w:r></w:p>`;
  emptyParagraphXML = `<w:p w:rsidR="00647784" w:rsidRDefault="00647784" w:rsidP="00FF1561"></w:p>`;
  emptyHeaderContent = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  emptyFooterContent = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  footNotesContent = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  endNotesContent = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  contentTypesContent = "";
  contentTypesParts = [`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  coreContent = "";
  coreContentParts = [`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  `;
  settingsContent = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  `;
  webSettingsContent = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  wordRelsContent = "";
  wordRelsParts = [`<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  wordThemeContent = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  public writeDocument(paperObj) {
    ...
    zip.file('[Content_Types].xml', this.contentTypesContent);
    zip.file('word/document.xml', this.wordDocumentContent);
    zip.file('word/fontTable.xml', this.fontTableContent);
    zip.file('word/settings.xml', this.settingsContent);
    zip.file('word/styles.xml', this.stylesContent);
    zip.file('word/webSettings.xml', this.webSettingsContent);
    zip.file('word/_rels/document.xml.rels', this.wordRelsContent);
    if (paperObj.headers.includeHeaders) {
      zip.file('word/header1.xml', this.emptyHeaderContent);
      zip.file('word/header2.xml', this.header2Content);
      zip.file('word/header3.xml', this.header3Content);
      zip.file('word/footer1.xml', this.emptyFooterContent);
      zip.file('word/footer2.xml', this.emptyFooterContent);
      zip.file('word/footer3.xml', this.emptyFooterContent);
      zip.file('word/footnotes.xml', this.footNotesContent);
      zip.file('word/endnotes.xml', this.endNotesContent);
    }
    zip.file('word/theme/theme1.xml', this.wordThemeContent);
  ...
  setHeaders(headerObj) {
    ...
    if (defaultHeader.leftType === "text") {
        this.header2Content += `<w:r><w:t>${defaultHeader.left}</w:t></w:r>`;
    }
    else if (defaultHeader.leftType === "pageNumber") {
...
setCore() {
    ...
    this.coreContent = `${this.coreContentParts[0]}${totoInsert}${this.coreContentParts[1]}${totoInsert}${this.coreContentParts[2]}`;
}

setTitlePage(titleObj) {
    var toReturn = "";
    ...
    if (onOwnPage) {
        for (var i = 0; i < emptyLineCount; i++) {
            toReturn += this.emptyParagraphXML;
        }
    }    
    for (var f in titleObj.fields) {
        var field = titleObj.fields[f];
        var toInsert: string = field.value;
    ...
    if (onOwnPage) {
        toReturn += this.pageBreakXML;
    }
    return toReturn;
}

setSummaryConclusion(sectionObj, breakBefore) {
    var toReturn = "";
    ...
    if (includeLabel) {
        ...
        var toInsert: string = sectionLabel.labelText;
    ...
    for (var p in sectionObj.paragraphs) {
        ...
        for (var f in paragraph.formatSections) {
            ...
            var toInsert: string = formatSection.content;
...
setDocument(myDoc) {
    this.wordDocumentContent = this.wordDocumentContentParts[0];

    this.wordDocumentContent += this.setTitlePage(myDoc.titleInfo);
    this.wordDocumentContent += this.setSummaryConclusion(myDoc.summaryAbstract, false);
    this.wordDocumentContent += this.setBody(myDoc.body);
    this.wordDocumentContent += this.setSummaryConclusion(myDoc.conclusion, true);
    this.wordDocumentContent += this.setReferences(myDoc.references);
    this.wordDocumentContent += this.wordDocumentContentParts[1];
    this.wordDocumentContent += this.setHeaderInfo(myDoc.headers);
    this.wordDocumentContent += this.wordDocumentContentParts[2];
    this.wordDocumentContent += `<w:titlePg/>`;
    this.wordDocumentContent += this.wordDocumentContentParts[3];
}
